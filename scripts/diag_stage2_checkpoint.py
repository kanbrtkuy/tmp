...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--expected_cot_offset", type=int, default=5)
    parser.add_argument("--min_exact_chain", type=float, default=0.99)
    parser.add_argument("--max_off_target", type=float, default=0.005)
    parser.add_argument("--max_malformed", type=float, default=0.005)
