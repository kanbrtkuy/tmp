...
if [ "$FULL_SFT_CANONICAL" = "true" ]; then
  ...
  for required_name in FULL_SFT_BASE_MODEL_PATH FULL_SFT_DATA_DIR FULL_SFT_DATASET_MANIFEST FULL_SFT_RESOLVED_CONFIG_PATH FULL_SFT_PROVENANCE_PATH FULL_SFT_CODE_FILES_JSON FULL_SFT_R2_ROOT FULL_SFT_STORAGE_PREFLIGHT_PATH; do
