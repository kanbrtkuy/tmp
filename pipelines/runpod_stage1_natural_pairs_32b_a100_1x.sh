...
BACKUP_ROOT=/workspace/cot-safety/runs/hot_backup_stage1_natural_pairs_32b_a100_1x_latest
...
log "Stage1 natural generated/generated pairs with 32B hidden extractor start"
log "Data: ${NATURAL_STAGE1_DATA_DIR}"
log "Config: stage1_natural_pairs_32b_a100_1x.yaml"
...
/workspace/venvs/stage1/bin/python scripts/run_stage1_positionscan.py \
  --config configs/experiment/stage1_natural_pairs_32b_a100_1x.yaml \
  --python /workspace/venvs/stage1/bin/python \
  --skip_existing

log "Backing up Stage1 natural 32B-hidden hot artifacts"
backup_run "stage1_natural_pairs_32b_a100_1x" "stage1_natural_pairs_32b_a100_1x"

log "Stage1b natural 32B-hidden prompt/pre-CoT baseline start"
/workspace/venvs/stage1/bin/python scripts/run_stage1b_prompt_baseline.py \
  --config configs/experiment/stage1b_natural_pairs_32b_a100_1x.yaml \
  --python /workspace/venvs/stage1/bin/python \
  --skip_existing

log "Backing up Stage1b natural 32B-hidden hot artifacts"
backup_run "stage1b_natural_pairs_32b_a100_1x" "stage1b_natural_pairs_32b_a100_1x"

log "Stage1 + Stage1b natural generated/generated pairs with 32B hidden extractor complete"
