...
echo "  PAUSE_KL_ENABLED=$PAUSE_KL_ENABLED continuation=$PAUSE_KL_CONTINUATION_WEIGHT emit=$PAUSE_KL_EMIT_WEIGHT suppression=$PAUSE_KL_SUPPRESSION_WEIGHT suppression_chunk=$PAUSE_KL_SUPPRESSION_CHUNK_SIZE invariant_check=$PAUSE_KL_POST_STEP_INVARIANT_CHECK invariant_interval=$PAUSE_KL_INVARIANT_CHECK_INTERVAL_STEPS"
