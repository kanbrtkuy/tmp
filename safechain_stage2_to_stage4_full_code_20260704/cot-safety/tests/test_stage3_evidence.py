...
def test_stage3_evidence_passes_only_when_pause_beats_prompt_and_control():
    rows = [
        {"model": "linear", "position": "pause_0", "layer": 14, "test_auroc": 0.82},
        {"model": "linear", "position": "last_prompt_token", "layer": 14, "test_auroc": 0.70},
        {"model": "linear", "position": "control_cot_3", "layer": 14, "test_auroc": 0.74},
    ]
...
def test_stage3_evidence_fails_when_prompt_baseline_matches_pause():
    rows = [
        {"model": "linear", "position": "pause_0", "layer": 14, "test_auroc": 0.82},
        {"model": "linear", "position": "pre_think", "layer": 14, "test_auroc": 0.83},
        {"model": "linear", "position": "control_cot_4", "layer": 14, "test_auroc": 0.74},
    ]
    report = build_stage3_evidence_report(rows, base_config())
